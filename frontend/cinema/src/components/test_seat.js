...
class Seats extends Component {
  ...
  constructor(props){
    ...
    this.state={
      ...
      cols: 0,
      seats: [],
      seats_styles: [["btn btn-success","btn btn-success"], ["btn btn-success","btn btn-success"]],
      reserved: [],
      selected_row: '',
      selected_col: ''
    };
  ...
  getReservedSeats()
  {
    ...
    .then(response=>{
        ...
        //     let resrvedRow = this.state.reserved[i].Row
        //     let resrvedCol = this.state.reserved[i].Col
        //     this.state.seats[resrvedRow-1][resrvedCol-1] ='btn-danger';
        // }
        this.updateStyle()
    })
    .catch(error=>{
                      ...
                      {row.map((col, col_index) => {
                        ...
                        return (
                          <li className="seat" key={(1+col_index)*1}>
                            <button key={(1+col_index)*2} className={ this.state.seats_styles[row_index][col_index]}
